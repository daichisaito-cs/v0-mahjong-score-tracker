...
"[project]/insane/workspace/playground/v0-mahjong-score-tracker/app/(authenticated)/games/page.tsx [app-ssr] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
var __TURBOPACK__imported__module__$5b$project$5d2f$insane$2f$workspace$2f$playground$2f$v0$2d$mahjong$2d$score$2d$tracker$2f$components$2f$games$2d$list$2e$tsx__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/insane/workspace/playground/v0-mahjong-score-tracker/components/games-list.tsx [app-ssr] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$insane$2f$workspace$2f$playground$2f$v0$2d$mahjong$2d$score$2d$tracker$2f$components$2f$ui$2f$card$2e$tsx__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/insane/workspace/playground/v0-mahjong-score-tracker/components/ui/card.tsx [app-ssr] (ecmascript)");
"use client";
;
;
...
function GamesPage() {
    ...
    const gamesQuery = (0, __TURBOPACK__imported__module__$5b$project$5d2f$insane$2f$workspace$2f$playground$2f$v0$2d$mahjong$2d$score$2d$tracker$2f$node_modules$2f2e$pnpm$2f40$tanstack$2b$react$2d$query$40$5$2e$90$2e$20_react$40$19$2e$2$2e$0$2f$node_modules$2f40$tanstack$2f$react$2d$query$2f$build$2f$modern$2f$useQuery$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useQuery"])({
        ...
        queryFn: async ()=>{
            ...
            const gameIds = (myResultsRes.data || []).map((r)=>r.game_id).filter(Boolean);
            const leagueIds = Array.from(new Set([
                ...(memberLeaguesRes.data || []).map((m)=>m.league_id),
                ...(ownedLeaguesRes.data || []).map((l)=>l.id)
            ])).filter(Boolean);
            const orConditions = [];
...
//# sourceMappingURL=insane_workspace_playground_v0-mahjong-score-tracker_4bfdc212._.js.map